...
if  [[ $1 = "-Feather" ]]; then
# Removing Old File
rm -rf $PDIR/bars.ini $PDIR/colors.ini $PDIR/config.ini $PDIR/modules.ini $PDIR/tester-file-1.ini $PDIR/tester-file-2.ini $PDIR/tester-file-3.ini $PDIR/user_modules.ini
# Coping New File
