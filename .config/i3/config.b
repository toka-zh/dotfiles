...
for_window [class="Battle.net"] float enable
for_window [class="网易云音乐"] float enable
#for_window [class=""] float enable
gaps inner 9
smart_borders on


exec_always --no-startup-id feh --bg-scale ~/Pictures/wallpaper/wallhaven-2kmq8m.jpg
...
bindsym $mod+p exec ~/.config/i3/display.sh
...
bindsym Alt+Space mode "$mode_system"
mode "$mode_system" {
